...
In your model, you can specify a style for the :original image and turn off
the reprocessing of the :original image. This allows you to reduce the size
of gigantic images **on the upload**, but leave the :original image untouched
every time you do re-cropping.
